...
public:
    ...
    struct tSoundPlayParams {
        ...
        // NOTSA Args //
        CEntityGTA*        RegisterWithEntity{};     //!< The entity to register this sound with (Automatically adds the `SOUND_LIFESPAN_TIED_TO_PHYSICAL_ENTITY` flag)
...
public:
    ...
    static inline CAESoundManager* AESoundManager;
    static CAESoundManager* getAESoundManager() {
        /*
        รอ MAP 2.11: CAESoundManager global instance
        sasamp-main 64-bit candidate was g_libGTASA + 0xBA9640
        */
        return AESoundManager;
    }
};
VALIDATE_SIZE(CAESoundManager, 0x9AE0);