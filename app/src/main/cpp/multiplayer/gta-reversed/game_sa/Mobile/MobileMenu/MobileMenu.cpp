...
{
    /* เพิ่มจาก sasamp-main: CMobileMenu::InjectHooks */
    gMobileMenu = reinterpret_cast<CMobileMenu*>(g_libGTASA + 0xD0DB20);
    ...
    /*
    รอ MAP 2.11: CMobileMenu destructor/Initialize hooks
