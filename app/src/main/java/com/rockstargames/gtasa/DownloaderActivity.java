...
public final class DownloaderActivity extends DownloaderActivityBase {
    private final DownloaderConfig config = new DownloaderConfig(
            ...
            CollectionsKt.listOf(new DownloaderPackConfig[] {
                    ...
                    new DownloaderPackConfig("data_sfx1", R.string.asset_pack_sfx1, DownloaderPackType.RUNTIME),
                    new DownloaderPackConfig("data_sfx2", R.string.asset_pack_sfx2, DownloaderPackType.RUNTIME),
                    new DownloaderPackConfig("data_streams", R.string.asset_pack_streams, DownloaderPackType.RUNTIME)
            })
    );
